...
const siteChecker = new SiteChecker({
    ...
    link: (result) => {
        ...
        for (const [brokenLink, foundOnPages] of Object.entries(brokenLinks)) {
            let markdownBrokenLink = `[${brokenLink}](https://weboftrust.github.io/keridoc/JSDoc/${brokenLink}.md)`;
            let pagesMarkdown = foundOnPages.map(page => `- [${page}](https://weboftrust.github.io/keridoc/JSDoc/${page}.md)`).join('\n');
            pagesMarkdown += '\n\n';
