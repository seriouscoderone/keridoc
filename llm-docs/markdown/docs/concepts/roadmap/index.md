...
-   Who is responsible for what in the process? Before we can answer these questions we need to step back for a moment and consider the _relationship-procedure-content_ funnel.
...
> "well, no, pay them better and they can be held accountable and responsible for meeting deadlines and meet the definition of done." "Isn't there proper project management on top of this?!".
...
1.  Focus on repository _Keripy_, then
...
Please read the sections _Relationship_ and _Procedure_ if you haven't done so before.
