...
![openapi-logo](https://github.com/WebOfTrust/keri/blob/main/images/openapi.png?raw=true)
...
![postman-logo](https://github.com/WebOfTrust/keri/blob/main/images/postman.png?raw=true)

Postman is an API platform for building and using APIs. Postman simplifies each step of the API lifecycle and streamlines collaboration so you can create better APIs—faster. [source](https://www.postman.com)

It is a sophisticated EDI for KERI APIs.

| TBW |

![paw-logo](https://github.com/WebOfTrust/keri/blob/main/images/paw.png?raw=true)
...
![XBRL-logo](https://github.com/WebOfTrust/keri/blob/main/images/XBRL.png?raw=true)
...
![Arelle-logo](https://github.com/WebOfTrust/keri/blob/main/images/Arelle.png?raw=true)
...
![Docker-logo](https://github.com/WebOfTrust/keri/blob/main/images/Docker.png?raw=true)
...
![ntru-logo](https://github.com/WebOfTrust/keri/blob/main/images/ntru.png?raw=true)
...
It might be an alternative to our Libsodium libs. But... - Looks like NTRUSign is broken. - NTRUEncrypt is usable. - pqNTRUSign uses large signature sizes so is not immediately suitable for IOT [More info](https://csrc.nist.gov/CSRC/media/Events/Second-PQC-Standardization-Conference/documents/accepted-papers/grobschadl-lighteight-implmentation-NTRUE.pdf)

It not as computational dense as alternatives. It is newer.

![caxe-logo](https://github.com/WebOfTrust/keri/blob/main/images/caxe.png?raw=true)
...
![gh-actions-logo](https://github.com/WebOfTrust/keri/blob/main/images/gh-actions.png?raw=true)
...
![gitflow-logo](https://github.com/WebOfTrust/keri/blob/main/images/gitflow.png?raw=true)
...
![Java-logo](https://github.com/WebOfTrust/keri/blob/main/images/Java_logo.png?raw=true)
...
![bazel-logo](https://github.com/WebOfTrust/keri/blob/main/images/bazel-logo.png?raw=true)
...
![webauth-logo](https://github.com/WebOfTrust/keri/blob/main/images/webauth.png?raw=true)
...
![npm-logo](https://github.com/WebOfTrust/keri/blob/main/images/npm.png?raw=true)

NPM is two things: first and foremost, it is an _online repository_ for the publishing of open-source Node.js projects; second, it is a _command-line utility_ for interacting with said repository that aids in package installation, version management, and dependency management. [Source](https://nodejs.org/en/knowledge/getting-started/npm/what-is-npm/)
...
![dart-logo](https://github.com/WebOfTrust/keri/blob/main/images/dart.png?raw=true)
