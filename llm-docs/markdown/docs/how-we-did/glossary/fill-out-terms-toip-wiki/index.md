...
Go to any of them, for example to the [acdc](https://github.com/weboftrustkeridoc/wiki) wiki of the KERI team. It's the KERI Suite terms there, so all about KERI, ACDC, CESR, OOBI, KERIA, IPEX, etc. keridoc/

1.  **Find a page**: To find a term just type part of it and the available list will be filtered instantly

![How to find a term in the terms wiki](https://weboftrust.github.io/keridoc/assets/images/find-a-page-7fbc71998ad31410b7760111e06c2aa0.md)

> this is a very handy feature when attending virtual meeting and the experts are throwing in various terms. you could save the newcomers by throwing links in the chat to the matching terms in the wiki.

![How to filter terms in the terms wiki](https://weboftrust.github.io/keridoc/assets/images/filter-pages-8fe05aea2b49254f7c841690645cdcc0.md)
...
```
![How to create a new term in the terms wiki](https://weboftrust.github.io/keridoc/assets/images/new-term-wiki-page-505ef75acd3f75601f04f3e58c9c5f1d.md)
...
```
## See
[composable event streaming representation](https://weboftrust.github.io/keridoc/docs/how-we-did/glossary/fill-out-terms-toip-wiki/composable-event-streaming-representation.md)
```
